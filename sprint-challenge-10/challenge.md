...
The relationshp between Employee and Territory is many to many. An employee can have many territories and a territory can have many employees. This relationship is mediated (that is to say, resolved or implemented) by the junction table EmployeeTerritories.

- What is a situation where a document store (like MongoDB) is appropriate, and
  what is a situation where it is not appropriate?

A situation where a document store like MongoDB is appropriate would be storing and management of so-called unstructured data, where the structure of the data as given is not perfectly known or not strictly relational, or the requirements of ACID are not paramount. Examples might be emails, an online chat system, XML files, or EDI transmissions of health plan enollment data.

A situation where MondoDB is not appropriate is where the data is primarily numerical and ACID is very important, such as a system to keep track of orders and payments at a fast-food restaurant. Or a bank deposit and withdrawl database.

- What is "NewSQL", and what is it trying to achieve?

"NewSQL" is a relatively new kind of database management system that tries to have the scalability of NoSQL with the protection of the traditional RDBMS without having to buy bigger and bigger computers or implement complex systems between the input system and the database. NewSQL is trying to accomodate modern "big data" and huge modern transaction loads, while also being as reliable as traditional relational databases at lower costs. By reliable, I mean specifically "ACID" or atomicity, consistency, isolation, and durability.
